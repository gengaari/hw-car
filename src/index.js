...
import CarDetails from './Pages/Cars/CarDetail';
...
const router = createBrowserRouter(
    createRoutesFromElements(
        <Route path='/' element={ <Root /> } >
            ...
            <Route path='cars/:carId' loader={carLoader} element={<CarDetails />} errorElement={<ErrorPage />} />
...
function carLoader({ params }) {
    return cars.find(c => c.id === params.carId);
}
